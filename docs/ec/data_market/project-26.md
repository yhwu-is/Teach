...
1. 可以自由组成不超过 3 人的小组完成大作业，截止时间：
    - 7.18 上午 9:00-12:00 中期展示（按表格顺序展示），所有小组在 7.18 0:00 前提交中期展示 PPT；
    - 虽然是中期展示，但如果你已经完成所有工作也可以展示最终结果
    - 每组展示时间为 7 分钟，之后有 2 分钟的问答环节
    - 最终报告提交截止时间 7.27 0:00

2. 下面给出三类选题参考：自由类、Agent-based Modeling 类和复现与改进类，具体含义与选题内容见下文；如果在以下推荐选题外还有自己感兴趣的题目，可以联系助教确定内容

3. 中期展示与最终报告提交的内容如下
    - 自由类
        - 中期展示：要求清晰介绍项目的架构（A.1）/研究的问题（A.2），已经实现的内容，以及后续的计划，原则上每组所有同学都要上台准备回答问题，但 1 人汇报即可，需要明确每个人的工作内容和分工以及 AI 的使用情况
        - 最终报告
